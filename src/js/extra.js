...
var taskObj = {
  ...
  //get current datetime in proper format(e.g. 2023-04-06 20:43:12)
    ...
    for (var a = 0; a < projects.length; a++) {
      ...
      for (var b = 0; b < projects[a].tasks.length; b++) {
        ...
        if (projects[a].tasks[b].status == "Progress") {
          ...
          html += "<option value ='progress'>Mark in Progress Again</option>";
        }
